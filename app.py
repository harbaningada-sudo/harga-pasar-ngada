...
# --- LOGIKA TAMPILAN ---
if data_tersedia:
    # 1. MENU BERANDA (DASHBOARD HARGA)
    if pilihan == "🏠 Beranda (Harga)":
        ...
        search = st.text_input("🔍 Cari Komoditas (Contoh: Beras, Cabai)...", "")
    ...
    # 5. MENU INFORMASI
        ...
        st.markdown("""
            <div class="card-container">
                ...
                <p>Portal ini merupakan bagian dari <b>Proyek Aktualisasi Latsar CPNS</b> Kabupaten Ngada untuk mewujudkan keterbukaan informasi publik.</p>
                <hr>
