...
# --- CSS KUSTOM GABUNGAN (MODERN & ATRAKTIF) ---
st.markdown("""
    <style>
...
def load_all_data():
    ...
    # Pembersihan baris kosong agar tidak muncul ikon pecah
...
# --- SIDEBAR NAVIGASI (MENGEMBALIKAN SEMUA MENU) ---
with st.sidebar:
...
if data_ok:
    if pilihan == "🏠 Dashboard Beranda":
        st.markdown('<div class="hero-section"><h1>Dashboard Ekonomi Ngada 👋</h1><p>Informasi harga bahan pokok terkini hari ini.</p></div>', unsafe_allow_html=True)
        ...
        st.info("Portal ini dibangun sebagai bagian dari Proyek Aktualisasi CPNS Kabupaten Ngada.")
