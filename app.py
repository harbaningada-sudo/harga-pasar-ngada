...
def load_data_berita():
    ...
    # Penyesuaian Kolom Berdasarkan Excel Terbaru: No, Kegiatan, Tipe, Link, Tanggal
    ...
    # 3. MENU BERITA (OTOMATISASI MEDIA)
        ...
        for _, row in df_berita.iterrows():
            ...
            with st.container():
                ...
                if "http" in link:
                    # Konversi Link Drive Otomatis agar Muncul Gambar
    ...
    # 5. MENU INFORMASI
        ...
        st.markdown("""
            <div class="card-container">
                ...
                <p>Portal ini merupakan bagian dari <b>Proyek Aktualisasi Latsar CPNS</b> Kabupaten Ngada untuk mewujudkan keterbukaan informasi publik di bidang perekonomian.</p>
                <hr>
                <p><b>Bagian Perekonomian & SDA</b><br>Pemerintah Kabupaten Ngada</p>
            </div>
        """, unsafe_allow_html=True)
